...
function trackThis(){
	...
	$('a:not([href^="tel:"]).trackThis').each(function(){
		$(this).click(function(){
			...
			_gaq.push(
				['_trackEvent', arguments[0], arguments[1], arguments[2], parseInt(arguments[3])]
			);
			return true;
		});
	}); 
		...
		if($('html').hasClass('no-touch')){
			...
			$(this).click(function(){
				...
				if($(this).hasClass('clicked')){
					_gaq.push(
						['_trackEvent', arguments[0], 'Clicked', arguments[2], 0]
					);	
					return true;
				}else{
					...
					_gaq.push(
						['_trackEvent', arguments[0], 'Revealed', arguments[2], parseInt(arguments[3])]
					);
					return false;		
				}
			});
